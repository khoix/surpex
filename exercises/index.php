      		  ...
      		  <div class="row justify-content-center">
           		 <div class="col-12 col-lg-8" style="font-family: Arial !important;">
           		 	<div style="background-color: white; border-radius: 25px; padding: 25px; box-shadow: 5px 5px 5px grey;">
							    ...
							    <thead>
							    	<button id="exercise-submit-btn" class="submit-btn">Submit Entry</button><br><br>
							        <tr>
										<th><input type="text" maxlength="35" id="name" name="name" placeholder="<Name>"></th>
										<th><input type="text" maxlength="100" id="description" name="description" placeholder="<Description>"></th>
										<th><input type="number" min="1" max="60" id="duration" name="duration" placeholder="#"></th>
							        </tr>
							    </thead>
							    <tbody>
